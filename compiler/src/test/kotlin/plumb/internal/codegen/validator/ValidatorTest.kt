...
abstract class ValidatorTest {
    ...
    protected fun getPlumberModelWithEntryIds(
        ...
        val list: MutableList<PlumberModel> = mutableListOf()
        entryIds.forEach { ids ->
            val model = PlumberModel(mockedElement, mockedElement,
    ...
    protected fun getMockedModelWithPlumberModels(
            plumberEntries: MutableList<PlumberModel> = mutableListOf()): Model {
        return Model(
                mockedRoundEnv,
                mockedFiler,
                mockedMessager,
